...
using Sistema_De_Cadastro_De_Contatos.Repositorio;

namespace Sistema_De_Cadastro_De_Contatos.Controllers
{
    ...
    public class ContatoController : Controller
    {
        ...
        public IActionResult Apagar(int id) 
        {
            ...
            {
                TempData["MensagemErro"] = $"Ops, não foi possível apagar seu contato, mais detalhes do erro: {erro.Message}";
                return RedirectToAction("Index");
            }
        }
